...
$(function () {
    ...
    var firebaseConfig = {
        apiKey: "AIzaSyBuoD5DIvfZdaxqheiAGesdr1BSzE3dvsk",
        authDomain: "maze-ecd28.firebaseapp.com",
        databaseURL: "https://maze-ecd28.firebaseio.com",
        projectId: "maze-ecd28",
        storageBucket: "maze-ecd28.appspot.com",
        messagingSenderId: "762080699619",
        appId: "1:762080699619:web:7f23985ebcc6c7311cd1d6",
    };
    // Initialize Firebase
    ...
    function updatePlayerLocation(uid, coord, write) {
        write = true;
        if (!PLAYERDIVS[uid]) {
            // create player
